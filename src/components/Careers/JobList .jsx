...
function JobCard({ job, user={} }) {
    return (
        <div className="bg-gray-50 p-8 rounded-xl shadow-lg transition-all hover:-translate-y-1 hover:shadow-2xl">
            {user?.admin == true && <Link href={`/dashboard/edit-job/${job?.id}`} className="flex items-center gap-2">
            ...
            <div className="flex flex-col md:flex-row gap-8">
                ...
                <div className="flex-1">
                    ...
                    <div>
                        ...
                        <p className="text-gray-700"> Hit the apply button or send your resume to: {job.contact_email || job.contact}</p>
                    </div>
                </div>
