  ...
  return (
    <main className="mx-auto max-w-screen-xl px-4 py-8 text-gray-800">
      ...
      <section className="mt-12">
        ...
        <div className="bg-gray-100 p-4 rounded-md mb-6">
          <div className="flex flex-col md:flex-row items-center gap-4">
            <div className="md:w-1/3 text-center">
              ...
              <div className="mt-1 text-yellow-500 text-lg md:text-xl">★★★★★</div>
            </div>
        ...
        {/* Scrollable Reviews */}
        <div className="max-h-80 overflow-y-auto pr-2 border-l border-r border-b rounded-b-md">
          {/* Single Review */}
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <div className="flex items-center justify-between">
                  <h6 className="font-semibold text-sm md:text-base">Esther</h6>
                  <span className="text-xs md:text-sm text-gray-400">Published</span>
                </div>
                <p className="text-xs md:text-sm text-gray-600">
                  Reviewed in Ghana on Sep 11, 2023
                </p>
                <div className="mt-1 flex items-center gap-1 text-yellow-500 text-sm md:text-base">
                  ★★★★★ <b className="text-gray-700 ml-1">Thank You!</b>
                </div>
      ...
      <section className="mt-12">
        ...
        <form className="mt-6 space-y-6">
          ...
          <button
            type="submit"
            className="bg-blue-600 text-white px-4 py-2 rounded font-semibold text-sm md:text-base"
          >
            Post review
          </button>
        </form>
