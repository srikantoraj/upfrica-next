            ...
            <section className="mt-8 max-w-xl">
                <div className="p-6 bg-white rounded-xl shadow-sm space-y-4">
                    ...
                    <div className="flex gap-2">
                        <button className="flex-1 border border-gray-300 rounded-full px-4 py-2 text-sm font-semibold">
                            Save seller
                        </button>
                        <Link
                            href={`/shops/${shop?.slug}`}
                            className="flex-1 border border-gray-300 rounded-full px-4 py-2 text-sm font-semibold"
                        >
                            Shop all items
                        </Link>
                    </div>
