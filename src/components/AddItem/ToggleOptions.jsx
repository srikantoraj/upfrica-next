      ...
      <ToggleSwitch
        ...
        description={
          <>
            ...
            <a href="https://www.ebay.co.uk/help/policies/listing-policies/images-text-policy?id=4240" target="_blank" rel="noreferrer" className="text-blue-600 underline">
              Learn more
            </a>
          </>
        }
...
const ToggleSwitch = ({ label, description, isOn, onToggle }) => (
  <div className="flex justify-between items-start">
    ...
    >
      ...
      <div className={`w-11 h-6 flex items-center bg-gray-300 rounded-full p-1 transition-colors ${isOn ? "bg-blue-600" : ""}`}>
        <div className={`bg-white w-4 h-4 rounded-full shadow-md transform transition-transform ${isOn ? "translate-x-5" : "translate-x-0"}`}></div>
      </div>
    </button>
  </div>
);
