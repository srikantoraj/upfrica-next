...
export default function EbayFooter() {
  const footerLinks = [
    ...
    { label: "Announcements", href: "https://community.ebay.co.uk/t5/Announcements/bg-p/Announcements" },
    { label: "Community", href: "https://community.ebay.co.uk" },
    { label: "Safety Centre", href: "https://pages.ebay.co.uk/safetycentre/index.html" },
    { label: "Seller Centre", href: "https://www.ebay.co.uk/sellercentre" },
    { label: "VeRO: Protecting Intellectual Property", href: "https://pages.ebay.co.uk/vero/index.html" },
    { label: "Policies", href: "https://www.ebay.co.uk/help/policies/az-index/az-index-policies?id=4649" },
    { label: "Product Safety Tips", href: "http://pages.ebay.co.uk/safetytips" },
