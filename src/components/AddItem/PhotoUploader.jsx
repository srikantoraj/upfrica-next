  ...
  return (
    <div className="p-6 border rounded-md shadow-sm bg-white space-y-6">
      ...
      <div className="flex justify-between items-center">
        ...
        <button onClick={() => setShowTips(true)} className="text-blue-600 hover:underline">
      ...
      <div className="border-2 border-dashed border-gray-300 p-6 text-center">
        <input type="file" accept="image/*" multiple onChange={handleImageUpload} className="hidden" id="upload-input" />
        <label htmlFor="upload-input" className="cursor-pointer text-gray-600">
          <div className="text-lg font-medium mb-2">Drag and drop files or click to upload</div>
          <div className="bg-blue-500 text-white px-4 py-2 inline-block rounded">Upload from Computer</div>
        </label>
      </div>
