...
const statusIcons = {
    success: <FaCheckCircle className="text-green-500 text-lg mx-auto" title="In Stock" />,
    warning: <FaClock className="text-yellow-500 text-lg mx-auto" title="Limited Stock" />,
    danger: <FaTimesCircle className="text-red-500 text-lg mx-auto" title="Out of Stock" />
};
...
const sampleProducts = [
    {
        ...
        brand: "https://html.phoenixcoded.net/light-able/bootstrap/assets/images/application/img-prod-brand-1.png"
    },
    {
        id: 2,
                            ...
                            <tbody>
                                {filteredProducts.slice(0, perPage).map(product => (
                                    <tr key={product.id} className="border-t hover:bg-gray-50 transition">
                                        ...
                                        <td className="text-right p-3">${product.price.toFixed(2)}</td>
                                        ...
                                        <td className="text-center p-3">
                                            <div className="flex items-center justify-center gap-3">
                                                ...
                                                <button
                                                    ...
                                                    title="Delete"
                                                    onClick={() => alert(`Deleting product ID: ${product.id}`)}
                                                >
                                                    <FaTrash />
                                                </button>
                                            </div>
