  ...
  return (
    <section id="what-is-ai" className="py-12 px-6 max-w-4xl mx-auto">
      ...
      <p className="text-lg text-gray-700 mb-4">
        When you think of AI — if you’re a nerd like me — your mind probably
        turns to Isaac Asimov: stories of robots, sentient metal beings, and
        science-fiction fantasy. But that’s still a few years off. Instead, the
      ...
      <p className="text-lg text-gray-700 mb-4">
        There are a variety of practical uses for AI. You’re probably most
      ...
      <div className="border-l-4 border-blue-600 pl-4 italic text-gray-800 mb-4">
        “Generative AI is already playing a huge role in tech, and it will only
        continue to get better and more powerful as time goes on,” said{" "}
        <strong>Troy Cox</strong>, Chief Product Officer at{" "}
        <strong>BigCommerce</strong>. “Within ecommerce specifically, there are
        huge possibilities, like search engine optimization, language chat
        services, translations, and image and content creation.”
      </div>
