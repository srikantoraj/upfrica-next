...
const Description = ({ formik }) => {
  ...
  useEffect(() => {
    if (editorRef.current && typeof formik.values.description === "string") {
      editorRef.current.setContent(formik.values.description || ""); // এখানে `description` কে ডিফল্টে খালি `string` দেয়া হচ্ছে
    }
