    ...
    return (
        <div className='container mx-auto py-5 px-2'>
            <div className="  p-6 text-center py-20">
                <h1 className="text-2xl lg:text-4xl font-bold tracking-wide mb-2">Today's Deals Up to 50% Off</h1>
                <p className="text-xl lg:text-2xl mb-4">
                    Best online sales items selling at low prices.
                </p>
                <p className="text-base lg:text-xl">
                    Have something to sell? <span className="font-semibold text-blue-400 underline">Sell on Upfrica</span>
                </p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {products.map((product) => (
                    <div key={product.id} className="border rounded-lg shadow-lg relative flex flex-col justify-between bg-white transition-transform transform hover:scale-105 hover:shadow-xl">
                        {/* Card Image Section */}
                        <div>
                            ...
                            <div className="px-4 pb-4">
                                ...
                                <div className="mt-4">
                                    <h2 className="text-xl font-bold text-gray-800">
                                        {product.title.length > 30 ? `${product.title.substring(0, 15)}...` : product.title}
                                    </h2>
                                </div>
