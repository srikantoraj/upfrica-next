        ...
        <>
                ...
                <div className="p-4 text-center container mx-auto max-w-5xl ">
                    {data.map((item) => (
                        <section key={item.id} className="mb-6 space-y-5">
                            <h2 className="text-3xl lg:text-7xl font-semibold text-purple-500 mb-2">{item.title}</h2>
                            <p className="text-base md:text-2xl font-bold mb-4">{item.description}</p>
                            <CommonButton
                            ...
                            <ul className="text-gray-600 space-y-2 text-center">
                                {item.data.map((point, i) => (
                                    <li key={i} className='flex gap-2 text-base  md:text-xl items-center justify-center text-center'>
            ...
            <section className='bg-gray-100 py-10'>
                <div className='container mx-auto px-4 max-w-5xl text-center space-y-8'>
                    <h1 className='font-bold text-2xl md:text-4xl'>How It Works with Drop Shipment</h1>
                    <ul className=" space-y-4 text-xl text-gray-700 px-4">
                        <li>Post any Upfrica item for sale on social media; your status, Facebook timeline, Instagram, or WhatsApp *at your own price</li>
                        <li>Promote the items through your channels to reach potential customers effectively.</li>
                        <li>Manage orders and ensure timely delivery to maintain customer satisfaction.</li>
                    </ul>
