...
import { FiTruck, FiCreditCard, FiEdit, FiPlus } from "react-icons/fi";
import { useRouter, useSearchParams } from "next/navigation";
import { Formik, Form, Field, ErrorMessage } from "formik";
import * as Yup from "yup";
import { useSelector } from "react-redux";
    ...
    <main className="container mx-auto px-4 py-8">
      ...
      <div className="grid xl:grid-cols-3 gap-8">
        ...
        <div className="xl:col-span-2 space-y-8">
          ...
          <section className="bg-white p-6 rounded-lg shadow">
            <h2 className="text-xl font-semibold flex items-center mb-4">
              <FiTruck className="mr-2 text-indigo-600" /> Shipping Address
            </h2>
            {selectedAddress ? (
              <>
                <div className="relative bg-gray-50 border rounded-lg p-4">
          ...
          <section className="bg-white p-6 rounded-lg shadow">
            <h2 className="text-xl font-semibold flex items-center mb-4">
              <FiCreditCard className="mr-2 text-indigo-600" /> Payment Method
            </h2>
            <div className="space-y-3">
              {["paystack", "stripe"].map((m) => (
                <label
