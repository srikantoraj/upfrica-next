...
const UpdateProfilePage = () => {
    ...
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            ...
            email: Yup.string()
                .email('ভুল ইমেইল ফরম্যাট')
                .required('Email প্রয়োজন'),
            phone: Yup.string()
                .matches(/^[0-9()+-\s]*$/, 'শুধুমাত্র নং, স্পেস, (+) বা (-) ব্যবহার করতে পারবেন')
        ...
        <div className="max-w-screen-2xl flex justify-center items-center mx-auto lg:p-10  min-h-screen">
            <div className='bg-white container grid lg:grid-cols-2 py-10 lg:px-20 shadow-xl border rounded-md'>
                ...
                <div className="hidden lg:flex w-1/2 items-center justify-center bg-white">
                    <Image src={profileImg} alt="Profile illustration" width={400} height={400} />
                </div>
                ...
                <div className="flex flex-1 items-center justify-center p-8">
                    <div className="w-full max-w-lg bg-white  p-6">
                        <div className="text-center mb-6">
                            <Image src={logo} alt="Logo" width={120} height={40} className="mx-auto" />
                            <h2 className="mt-4 text-2xl font-semibold text-gray-800">
                                Update Your Profile
                            </h2>
                        </div>
                        ...
                        <form onSubmit={formik.handleSubmit} className="space-y-4">
                            ...
                            <div>
                                ...
                                />
                                {formik.touched.first_name && formik.errors.first_name && (
                                    <p className="mt-1 text-red-500 text-sm">{formik.errors.first_name}</p>
                                )}
                            </div>
                            ...
                            <div>
                                ...
                                {formik.touched.last_name && formik.errors.last_name && (
                                    <p className="mt-1 text-red-500 text-sm">{formik.errors.last_name}</p>
                                )}
                            </div>
