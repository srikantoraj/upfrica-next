        ...
        <div className='flex flex-col min-h-screen'>
            ...
            <div className="flex justify-center items-center bg-gradient-to-r from-purple-200 via-blue-200 to-purple-100 py-20">
                <div className="text-center container">
                    <h1 className="text-3xl font-extrabold text-gray-800 mb-4">Upfrica BD</h1>
                    <h2 className="text-5xl font-bold text-gray-700 mb-4">A unique marketplace for online buyers and sellers.</h2>
                    <p className="text-xl font-medium text-gray-600 mb-8">Enjoy shopping for the items you love at the best prices. Buy or Sell, deliver & process payments.</p>
            ...
            <div className='py-20 container mx-auto'>
                <h1 className='text-3xl text-purple-500 font-bold text-right mb-10'>Selling with Upfrica</h1>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
                    {workData.map((work) => (
                        <div key={work.id} className="flex flex-col items-start relative bg-white shadow-lg rounded-lg p-6 transition transform hover:scale-105 duration-200">
                            ...
                            <h1 className="text-2xl font-bold mt-24 text-gray-800 mx-auto">{work.name}</h1>
            ...
            <div className="bg-gray-100 p-10 rounded-lg max-w-lg mx-auto text-center space-y-6 shadow-md">
                <h2 className="text-2xl font-bold text-gray-700">Our WhatsApp Contact</h2>
                ...
                <button className="bg-purple-500 hover:bg-purple-600 text-white px-6 py-3 rounded-full font-semibold transition duration-300">
                    <Link href={"/signin"}>Start Selling</Link>
                </button>
            </div>
