                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="flex items-center">
                        <input
                            ...
                            id="confirmed"
                        />
                        <label htmlFor="confirmed" className="ml-2">Verified</label>
                    </div>

                    <button
                        type="submit"
                        disabled={saving}
                        className={`w-full flex justify-center items-center py-2 rounded-full text-white ${saving ? 'bg-gray-400 cursor-not-allowed' : 'bg-violet-600 hover:bg-violet-700'
                            }`}
                    >
