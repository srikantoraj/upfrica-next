        ...
        >
          {({
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <label className="block text-gray-700 font-bold mb-1">
                  Blog Categories (you can select multiple**)
                </label>
                <select
                  name="categories"
                  multiple
                                    ...
                                    {(section.bulletItems || []).map(
                                      (item, idx) => (
                                        ...
                                        >
                                          <input
                                            type="text"
                                            name={`sections[${secIndex}].bulletItems[${idx}]`}
                                            value={item}
                                            onChange={handleChange}
                                            onBlur={handleBlur}
                                            placeholder="Bullet item"
                                      ...
                                      {(section.tableHeaders || []).map(
                                        (hdr, idx) => (
                                          ...
                                          >
                                            <input
                                              type="text"
                                              name={`sections[${secIndex}].tableHeaders[${idx}]`}
                                              value={hdr}
                                              onChange={handleChange}
                                              onBlur={handleBlur}
                                              placeholder="Header"
                                      ...
                                      {(section.tableRows || []).map(
                                        (row, rowIdx) => (
                                          ...
                                          >
                                            ...
                                            <FieldArray
                                              name={`sections[${secIndex}].tableRows[${rowIdx}]`}
                                            >
                                              {({ push, remove }) => (
                                                <div className="space-y-2">
                                                  {row.map((cell, cIdx) => (
                                                    ...
                                                    >
                                                      <input
                                                        type="text"
                                                        name={`sections[${secIndex}].tableRows[${rowIdx}][${cIdx}]`}
                                                        value={cell}
                                                        onChange={handleChange}
                                                        onBlur={handleBlur}
                                                        placeholder="Cell"
