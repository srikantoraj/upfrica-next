...
const initialFormValues = {
    ...
    summary: "Etsy offers many delivery tools to help you set postage rates in your shop.",
...
const PreviewTable = ({ sections }) => {
    return (
        <div className="overflow-x-auto my-8 border-t pt-8">
            <h2 className="text-2xl font-bold text-violet-700 mb-4">Preview Sections Data</h2>
...
export default function CreateHelpBlogPage() {
    return (
        <div className="min-h-screen bg-gray-50 p-4">
            <h1 className="text-3xl font-bold text-violet-700 mb-6">Create Help Blog Post</h1>
            <Formik
                ...
                {({
                    ...
                    <>
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            {/* Tags */}
                            <div>
                                <label className="block text-gray-700 font-bold mb-1">Tags</label>
                            ...
                            {/* Sections */}
                            <div>
                                <label className="block text-gray-700 font-bold mb-1">Sections</label>
                                                            ...
                                                            <FieldArray name={`sections[${secIndex}].links`}>
                                                                {({ push, remove }) => (
                                                                    <div className="space-y-2">
                                                                        ...
                                                                        <button
                                                                            type="button"
                                                                            onClick={() => push({ text: "New Link", url: "https://example.com" })}
                                                                            className="text-violet-700 underline"
                                                                        >
                                                                            + Add Link
                                                                        </button>
